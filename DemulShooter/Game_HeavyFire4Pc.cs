...
{
    /*** HeavyFire4 => Heavy Fire Shattered Spear ***/
    class Game_HeavyFire4Pc : Game
    {
        ...
        protected byte _P2_Trigger_VK = Win32.VK_NUMPAD7;
        protected byte _P2_Reload_VK = Win32.VK_NUMPAD9;
        protected byte _P2_Grenade_VK = Win32.VK_NUMPAD8;
        protected byte _P2_CoverLeft_VK = Win32.VK_NUMPAD4;
        protected byte _P2_CoverRight_VK = Win32.VK_NUMPAD2;
        protected byte _P2_CoverDown_VK = Win32.VK_NUMPAD6;
            ...
            : base()
        {
            ...
            _Target_Process_Name = "HeavyFire4";
            if (_RomName.Equals("hfss_s") || _RomName.Equals("hfss2p_s"))
            {
