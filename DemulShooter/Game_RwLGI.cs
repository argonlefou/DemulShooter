...
namespace DemulShooter
{
    class Game_RwLGI : Game
    {
        ...
        /// Constructor
        /// </summary>
        public Game_RwLGI(string RomName, bool ParrotLoaderFullHack, bool Verbose) 
            : base ()
        {
            GetScreenResolution();
            ...
            _Target_Process_Name = "LGI_RingW_F_Safe";
                ...
                try
                {
                    ...
                    if (processes.Length > 0)
                    {
                        ...
                        if (_TargetProcess_MemoryBaseAddress != IntPtr.Zero)
                        {
                            ...
                            byte[] bTampon = ReadBytes((int)_TargetProcess_MemoryBaseAddress + 0x0080c88c, 4);
        ...
        private void SetHack2()
        {
            ...
            SetNops((int)_TargetProcess_MemoryBaseAddress, _Axis_NOP_Offset);
            //NOPing TEST proc
            SetNops((int)_TargetProcess_MemoryBaseAddress, "0x002F0BB3|3");
            //NOPing Buttons proc
            SetNops((int)_TargetProcess_MemoryBaseAddress, "0x002F0B72|3");
