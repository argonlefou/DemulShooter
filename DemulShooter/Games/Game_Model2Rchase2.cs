...
namespace DemulShooter
{
    ...
    {     
        ...
        public Game_Model2Rchase2(String RomName, double _ForcedXratio, bool Verbose)
            : base(RomName, "EMULATOR", _ForcedXratio, Verbose)
        {
        ...
        private void CreateDataBank()
        {
            ...
            _P2_X_CaveAddress = CaveMemoryInput.CaveAddress;
            _P1_X_CaveAddress = CaveMemoryInput.CaveAddress + 1;
            _P2_Y_CaveAddress = CaveMemoryInput.CaveAddress + 2;
            _P1_Y_CaveAddress = CaveMemoryInput.CaveAddress + 3;
            //And for buttons
            _Buttons_CaveAddress = CaveMemoryInput.CaveAddress + 8;

            Logger.WriteLog("Custom data will be stored at : 0x" + _P2_X_CaveAddress.ToString("X8"));
        }
        ...
        protected override void CreateOutputList()
        {
            ...
            _Outputs.Add(new GameOutput(OutputDesciption.P1_LmpStart, OutputId.P2_LmpStart));
