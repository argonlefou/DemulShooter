...
namespace DemulShooter
{
    class Game_Lindbergh2spicy : Game
    {
        ...
        private void SetHack_OverwriteTrigger()
        {
            ...
            CaveMemory.Write_jmp(_Trigger_Injection_Return_Address);
            ...
            UInt32 jumpTo = 0;
            jumpTo = CaveMemory.CaveAddress - (_Trigger_Injection_Address) - 5;
            Buffer = new List<byte>();
            Buffer.Add(0xE9);
            Buffer.AddRange(BitConverter.GetBytes(jumpTo));
            Buffer.Add(0x90);
            Buffer.Add(0x90);
            Win32API.WriteProcessMemory(ProcessHandle, _Trigger_Injection_Address, Buffer.ToArray(), (UInt32)Buffer.Count, ref bytesWritten);
        }
