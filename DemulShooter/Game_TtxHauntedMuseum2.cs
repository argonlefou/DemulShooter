...
namespace DemulShooter
{
    class Game_TtxHauntedMuseum2 : Game
    {
        ...
        protected int _ScreenWidth_Offset = 0x00332EF0;
        protected int _ScreenHeight_Offset = 0x00332EF4;
        ...
        /// Constructor
        /// </summary>
        public Game_TtxHauntedMuseum2(string RomName, bool AlternativeGameplay, bool Verbose)
            : base()
        {
            GetScreenResolution();
        ...
        {
            int GetKeyboardState_Address = 0x00266348;
            int LpKeystate_Address = 0x00AEF498;
