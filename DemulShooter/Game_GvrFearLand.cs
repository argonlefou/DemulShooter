...
namespace DemulShooter
{
    class Game_GvrFearLand : Game
    {
        ...
        protected int _P2_Action_Address;
        ...
        protected int _ScreenWidth_Offset = 0x00498B50;
        protected int _ScreenHeight_Offset = 0x00498B54;
        ...
        /// Constructor
        /// </summary>
        public Game_GvrFearLand(string RomName, bool AlternativeGameplay, bool Verbose) 
            : base ()
        {
            GetScreenResolution();
        ...
        private void SetHack()
        {
            ...
            _P1_Action_Address = CaveMemory.CaveAddress + 0x58;
            ...
            _P2_Action_Address = CaveMemory.CaveAddress + 0x78;
        ...
        private void HackTrigger_V4()
        {
            int GetKeyboardState_Address = 0x002D6388;
            int LpKeystate_Address = 0x00C55118;
            if (_RomName.Equals("hm2"))
            {
                GetKeyboardState_Address = 0x00266348;
                LpKeystate_Address = 0x00AEF498;
            }
            ...
            byte[] b = BitConverter.GetBytes((int)_TargetProcess_MemoryBaseAddress + GetKeyboardState_Address);
            CaveMemory.Write_Bytes(b);
            //and [lpkeystate + 1], 0xFF00FFFF
            CaveMemory.Write_StrBytes("81 25");
            b = BitConverter.GetBytes((int)_TargetProcess_MemoryBaseAddress + LpKeystate_Address + 1); /*0x00C55119*/
            CaveMemory.Write_Bytes(b);
            ...
            //cmp [_P1_Action], 80
            CaveMemory.Write_StrBytes("81 3D");
            b = BitConverter.GetBytes(_P1_Action_Address);
            CaveMemory.Write_Bytes(b);
            CaveMemory.Write_StrBytes("80 00 00 00");
            //jne P2_Trigger
            CaveMemory.Write_StrBytes("0F 85 0A 00 00 00");
            //or [lpkeystate + X], 80
            CaveMemory.Write_StrBytes("81 0D");
            b = BitConverter.GetBytes((int)_TargetProcess_MemoryBaseAddress + LpKeystate_Address + 51); /*0x00C5514B*/
            CaveMemory.Write_Bytes(b);
            CaveMemory.Write_StrBytes("80 00 00 00");
            ...
            //or [lpkeystate + 2], 80
            CaveMemory.Write_StrBytes("81 0D");
            b = BitConverter.GetBytes((int)_TargetProcess_MemoryBaseAddress + LpKeystate_Address + 2); /*0x00C5511A*/
            CaveMemory.Write_Bytes(b);
            CaveMemory.Write_StrBytes("80 00 00 00");
            //P2_Action:
            //cmp [_P2_Action], 80
            CaveMemory.Write_StrBytes("81 3D");
            b = BitConverter.GetBytes(_P2_Action_Address);
            CaveMemory.Write_Bytes(b);
            CaveMemory.Write_StrBytes("80 00 00 00");
            //jne exit
            CaveMemory.Write_StrBytes("0F 85 0A 00 00 00");
            //or [lpkeystate + X], 80
            CaveMemory.Write_StrBytes("81 0D");
            b = BitConverter.GetBytes((int)_TargetProcess_MemoryBaseAddress + LpKeystate_Address + 52); /*0x00C5514C*/
            CaveMemory.Write_Bytes(b);
            CaveMemory.Write_StrBytes("80 00 00 00");
