...
{
    /// <summary>
    /// This class is used to create a virtual XInput device so that a game can believe that a Gamepad is plugged
    /// We can then simulate Axis and Buttons values to control in-game actions.
    /// This is meant to be used with BlueEstate and FarCry but both are still Work-In-Progress for many reasons....
    /// </summary>
