    ...
    class mKaboomManager
    {
        ...
        class StartMotorPwm
        {
            static bool Prefix(KaboomOutput.MotorPwmId MotorId, byte un8PwmDutyCycle, ushort iMsDuration = 144)
            {
                ...
                if (MotorId.ToString().Contains("P1"))
                    Demulshooter_Plugin.RHA_Mmf.Payload[RHA_MemoryMappedFile_Controller.INDEX_P1_MOTOR] = 1;
                else if (MotorId.ToString().Contains("P2"))
                    Demulshooter_Plugin.RHA_Mmf.Payload[RHA_MemoryMappedFile_Controller.INDEX_P2_MOTOR] = 1;
                else if (MotorId.ToString().Contains("P3"))
                    Demulshooter_Plugin.RHA_Mmf.Payload[RHA_MemoryMappedFile_Controller.INDEX_P3_MOTOR] = 1;
                else if (MotorId.ToString().Contains("P4"))
                    Demulshooter_Plugin.RHA_Mmf.Payload[RHA_MemoryMappedFile_Controller.INDEX_P4_MOTOR] = 1;
        ...
        class StopMotorPwm
        {
            static bool Prefix(KaboomOutput.MotorPwmId MotorId)
            {
                ...
                if (MotorId.ToString().Contains("P1"))
                    Demulshooter_Plugin.RHA_Mmf.Payload[RHA_MemoryMappedFile_Controller.INDEX_P1_MOTOR] = 0;
                else if (MotorId.ToString().Contains("P2"))
                    Demulshooter_Plugin.RHA_Mmf.Payload[RHA_MemoryMappedFile_Controller.INDEX_P2_MOTOR] = 0;
                else if (MotorId.ToString().Contains("P3"))
                    Demulshooter_Plugin.RHA_Mmf.Payload[RHA_MemoryMappedFile_Controller.INDEX_P3_MOTOR] = 0;
                else if (MotorId.ToString().Contains("P4"))
                    Demulshooter_Plugin.RHA_Mmf.Payload[RHA_MemoryMappedFile_Controller.INDEX_P4_MOTOR] = 0;
