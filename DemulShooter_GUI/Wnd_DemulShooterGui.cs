...
{    
    public partial class Wnd_DemulShooterGui : Form
    {
        ...
        {           
            ...
            TXT_P2_T.Text = _Configurator.DIK_Sha_P2_Trigger.ToString();
            TXT_EXIT.Text = _Configurator.DIK_Sha_Exit.ToString();
            TXT_SERVICE.Text = _Configurator.DIK_Sha_Service.ToString();
        ...
        private void InstallM2Scripts()
        {
            ...
            try
            {
                ...
                streamWriter.WriteLine("P2_ChangeCrosshairKey=0x" + ((byte)_Configurator.DIK_M2_Crosshair_P1).ToString("X2"));
