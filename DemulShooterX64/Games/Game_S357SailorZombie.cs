...
namespace DemulShooterX64
{
    public class Game_S357SailorZombie : Game
    {
        ...
        /// Constructor
        /// </summary>
        public Game_S357SailorZombie(String RomName, Configurator MyConfigurator, bool DisableInputHack, bool Verbose)
                        ...
                        if (_TargetProcess_MemoryBaseAddress != IntPtr.Zero)
                        {
                            foreach (IntPtr handle in EnumerateProcessWindowHandles(_TargetProcess.Id))
                            {
                                ...
                                if (length >= 0)
                                {
                                    ...
                                    if (WindowTitle.StartsWith("FPS:") || WindowTitle.Contains("Sailor zombie"))
                                    {
