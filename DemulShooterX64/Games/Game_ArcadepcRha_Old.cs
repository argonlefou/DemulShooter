...
{
    class Game_ArcadepcRha_Old : Game
    {
        ...
        /// Constructor
        /// </summary>
        public Game_ArcadepcRha_Old(String RomName)
            : base(RomName, "Game")
        {
        ...
        public override void UpdateOutputValues()
        {
            ...
            if (r == 0)
            {
                ...
                SetOutputValue(OutputId.P1_Credits, BitConverter.ToInt32(_Mmfh.Payload, MMFH_RabbidsHollywood.INDEX_P1_CREDITS));
                SetOutputValue(OutputId.P2_Credits, BitConverter.ToInt32(_Mmfh.Payload, MMFH_RabbidsHollywood.INDEX_P2_CREDITS));
                SetOutputValue(OutputId.P3_Credits, BitConverter.ToInt32(_Mmfh.Payload, MMFH_RabbidsHollywood.INDEX_P3_CREDITS));
                SetOutputValue(OutputId.P4_Credits, BitConverter.ToInt32(_Mmfh.Payload, MMFH_RabbidsHollywood.INDEX_P4_CREDITS));
