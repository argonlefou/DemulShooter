...
{
    public class RHA_MemoryMappedFile_Controller
    {
        ...
        public RHA_MemoryMappedFile_Controller(string MMF_Name, string Mutex_Name, long lngSize)
        {
            _sMmfName = MMF_Name;
        ...
        ~RHA_MemoryMappedFile_Controller()
        {
            MMFClose();
        }
