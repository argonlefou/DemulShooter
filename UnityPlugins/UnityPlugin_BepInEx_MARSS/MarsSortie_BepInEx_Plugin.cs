...
namespace UnityPlugin_BepInEx_MarsSortie
{
    ...
    public class MarsSortie_BepInEx_Plugin : BaseUnityPlugin
    {
        public const String pluginGuid = "argonlefou.demulshooter.mars.sortie";
        public const String pluginName = "MarsSortie_BepInEx_Plugin";
        public const String pluginVersion = "1.0.0.0";

        public static BepInEx.Logging.ManualLogSource MyLogger;

        public static MarsSortie_BepInEx_Plugin Instance = null;
